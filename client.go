...
// interacting with the bila API. You should not instantiate this client directly,
...
// DefaultClientOptions read from the environment (BILA_API_KEY, BILA_BASE_URL).
// This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithHTTPClient(defaultHTTPClient()), option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("BILA_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("BILA_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("BILA_CUSTOM_HEADERS"); ok {
...
// environment (BILA_API_KEY, BILA_BASE_URL). The option passed in as arguments are
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.TransferRecipients = NewTransferRecipientService(opts...)
	...
	r.Banks = NewBankService(opts...)
	r.Resolve = NewResolveService(opts...)
