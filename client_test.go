...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Accounts.List(context.Background(), bila.AccountListParams{})
	if userAgent != fmt.Sprintf("Bila/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Accounts.List(context.Background(), bila.AccountListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Accounts.List(cancelCtx, bila.AccountListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Accounts.List(deadlineCtx, bila.AccountListParams{})
		if err == nil {
