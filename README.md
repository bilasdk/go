...
The Bila Go library provides convenient access to the Bila REST API
...
```sh
go get -u 'github.com/bilasdk/go@v0.2.0'
```
...
`*bila.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `bila.File(reader io.Reader, filename string, contentType string)`
